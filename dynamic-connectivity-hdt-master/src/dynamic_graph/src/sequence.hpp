...
class Element {
 public:
  ...
  std::set<int64_t> getComponent() const;
  ...
  int64_t getSeqRoot();
  void print();
  std::pair<int64_t, int64_t> root_node_ = {-1,-1};
  std::pair<int64_t, int64_t> getRoot_optimized(int64_t node);
 private:
  ...
  void getComponent(std::set<int64_t>* output) const;
